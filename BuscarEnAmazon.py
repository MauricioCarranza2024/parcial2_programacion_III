...
if 'amazon' in hablar():
    engine.say('¿Claro, Qué quieres buscar en Amazon?')  # Pregunta al usuario
    ...
    if search_text:  # Asegúrate de que no sea una cadena vacía
        webbrowser.open(f'https://www.amazon.es/s?k={search_text}')  # Abre la búsqueda de Google con el texto
